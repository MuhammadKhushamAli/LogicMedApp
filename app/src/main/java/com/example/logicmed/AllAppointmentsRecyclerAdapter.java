...
public class AllAppointmentsRecyclerAdapter extends FirestoreRecyclerAdapter<Appointment, AllAppointmentsRecyclerAdapter.AppointmentViewHoler> {
    ...
    public AllAppointmentsRecyclerAdapter(@NonNull FirestoreRecyclerOptions<Appointment> options, Context context, setOnClickListener listener) {
        super(options);
